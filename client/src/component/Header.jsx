    ...
    <header className="bg-blue-200 shadow-md">
        ...
        <Link to='/'>
            ...
            <form className="bg-blue-100 border-2 border-blue-300 p-3 rounded-lg flex items-center">
                <input type="text" name="" placeholder="Search..." className="bg-transparent focus:outline-none w-24 sm:w-64" />
                <button>
            ...
            <ul className="flex gap-2 sm:gap-4">
                ...
                <Link to='/sign-in'>
                <li className="hover:underline cursor-pointer text-slate-700">Sign in</li>
                </Link>
            </ul>
        </div>
    </header>
